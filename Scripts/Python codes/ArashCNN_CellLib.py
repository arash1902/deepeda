...
from readMat_CellLib import CirRecDataset,next_batch,selection
...
### run it
def run_CNNCL(ran_seed,fileOut,idx):
# %matplotlib inline
	...
	# div_data2 = all_data2[0:868]
	# mul_data2 = all_data2[871:1209]
	# mod_data2 = all_data2[1212:2079]
	# div_labels2 = all_labels2[0:868]
	# mul_labels2 = all_labels2[871:1209]
	# mod_labels2 = all_labels2[1212:2079]
	# div_data2, div_labels2 = next_batch(div_data2.shape[0], div_data2, div_labels2)
	# mul_data2, mul_labels2 = next_batch(mul_data2.shape[0], mul_data2, mul_labels2)
	# mod_data2, mod_labels2 = next_batch(mod_data2.shape[0], mod_data2, mod_labels2)
	# div_data = div_data2[0:200]
	# mul_data = mul_data2[0:200]
	# mod_data = mod_data2[0:200]
	# div_labels = div_labels2[0:200]
	# mul_labels = mul_labels2[0:200]
	# mod_labels = mod_labels2[0:200]
	...
	all_data, all_labels = selection(idx, all_data2, all_labels2)
	...
	conv_layers = {}
	_, test_accuracy, parameters = model(X_train, Y_train, X_test, Y_test, X_validation, Y_validation)
	fileOut.write('%f,'  % test_accuracy)
##########################################################
